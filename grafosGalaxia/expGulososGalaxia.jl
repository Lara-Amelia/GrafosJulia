...
function generate_best_summary_table(results_data, filename, graph_type)
    ...
    # [CORREÇÃO 1/2]: Ajusta o título para refletir 'todos os v'
...
# --- FUNÇÃO DE GERAÇÃO DE TABELA DETALHADA (MODIFICADA) ---
...
function generate_detailed_table(results_data, filename, graph_type)
    ...
    # [CORREÇÃO 2/2]: Ajusta o título para refletir 'todos os v'
...
function main()
    ...
    heuristics = Dict(
        ...
        :sat_deg => NOVOcoloracaoHarmonicaSaturacao! # Assumindo a versão corrigida
    )
    ...
    for file_name in galaxy_files
        ...
        if data !== nothing
            ...
            # >>> LÓGICA DE FILTRAGEM CORRIGIDA AQUI <<<
            if a_param <= 25 
