# experimentos SBPO Standard GA com Operadores Customizados e Checkpoints
...
function CustomGAParams(; N = 100, p_mutation = 0.2, stag_limit = 20, 
...
function main()
    ...
    csv_path = "results_GA_pmutation0.2_stag20_progresso.csv"
